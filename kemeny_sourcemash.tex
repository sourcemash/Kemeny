...
Instructions for installation, execution, and testing are maintained at \url{https://github.com/sourcemash/Sourcemash/blob/master/README.md}, and are reproduced as of \today\ below. Sourcemash runs on Mac OS X and the Linux computers (recommended: \texttt{darwin}) available in Sudikoff 001.
	...
	\item Run Locally
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item Start up an instance of the worker: \texttt{python manage.py scrape\_worker \& python manage.py user\_tasks\_worker \&}
			\end{enumerate}
			\item Start up the scraper: \texttt{python manage.py scrape}
			\item Open Sourcemash in your preferred browser on localhost (default port: 5000)
		\end{enumerate}
	\item Testing
	\begin{enumerate}
